...
RESTAURANTS = [
    ...
    },
    {
        "name": "강남 크로플 카페",
        "region": "강남", "region_aliases": ["강남", "강남구", "서울"],
        "food_type": "디저트", "cuisine": "카페·디저트",
        "signature_menu": "시그니처 크로플",
        "price_tier": "1만원 이하", "avg_price_display": "1인 약 9,000원",
        "moods": ["조용한", "혼밥", "분위기 좋은"],
        "features": ["웨이팅짧음"],
        "rating": 4.4, "review_count": 221,
        "hours": "매일 10:00 - 22:00",
        "address": "서울 강남구 청담동 일대",
        "description": "아기자기한 소품이 가득한 조용한 디저트 카페.",
    },
    {
        "name": "강남 후라이드킹",
        "region": "강남", "region_aliases": ["강남", "강남구", "서울"],
        "food_type": "치킨", "cuisine": "치킨·맥주",
        "signature_menu": "바삭 후라이드",
        "price_tier": "1~2만원", "avg_price_display": "1인 약 18,000원",
        "moods": ["캐주얼", "회식"],
        "features": ["단체가능", "웨이팅짧음"],
        "rating": 4.3, "review_count": 402,
        "hours": "매일 15:00 - 01:00",
        "address": "서울 강남구 삼성동 일대",
        "description": "바삭한 튀김옷이 매력적인 치킨 맛집.",
    },
    {
        "name": "홍대 숯불양념갈비",
        "region": "홍대", "region_aliases": ["홍대", "마포", "서울"],
        "food_type": "고기", "cuisine": "돼지갈비",
        "signature_menu": "숯불 양념갈비",
        "price_tier": "2~3만원", "avg_price_display": "1인 약 23,000원",
        "moods": ["회식", "캐주얼", "가족"],
        "features": ["단체가능"],
        "rating": 4.3, "review_count": 288,
        "hours": "매일 16:00 - 23:30",
        "address": "서울 마포구 서교동 일대",
        "description": "연기 자욱한 숯불에 직접 구워주는 양념갈비집.",
    },
    {
        "name": "홍대 손칼국수",
        "region": "홍대", "region_aliases": ["홍대", "마포", "서울"],
        "food_type": "한식", "cuisine": "칼국수",
        "signature_menu": "얼큰 손칼국수",
        "price_tier": "1만원 이하", "avg_price_display": "1인 약 9,500원",
        "moods": ["혼밥", "캐주얼"],
        "features": ["웨이팅짧음"],
        "rating": 4.2, "review_count": 245,
        "hours": "매일 10:30 - 21:00",
        "address": "서울 마포구 동교동 일대",
        "description": "직접 뽑은 면발이 쫄깃한 동네 칼국수집.",
    },
    {
        "name": "성수 매콤제육식당",
        "region": "성수", "region_aliases": ["성수", "성동구", "서울"],
        "food_type": "한식", "cuisine": "제육볶음",
        "signature_menu": "매콤 제육볶음 정식",
        "price_tier": "1만원 이하", "avg_price_display": "1인 약 10,000원",
        "moods": ["혼밥", "캐주얼"],
        "features": ["웨이팅짧음"],
        "rating": 4.3, "review_count": 267,
        "hours": "매일 11:00 - 21:00",
        "address": "서울 성동구 성수동 일대",
        "description": "빠르게 든든한 한 끼를 즐길 수 있는 제육 맛집.",
    },
    {
        "name": "성수 후라이드킹 2호점",
        "region": "성수", "region_aliases": ["성수", "성동구", "서울"],
        "food_type": "치킨", "cuisine": "치킨·맥주",
        "signature_menu": "양념 반 후라이드 반",
        "price_tier": "1~2만원", "avg_price_display": "1인 약 19,000원",
        "moods": ["캐주얼", "회식"],
        "features": ["단체가능"],
        ...
        "address": "서울 성동구 성수동 일대",
        "description": "골목 안쪽에 숨어 있는 로컬 치킨 맛집.",
    },
    {
        "name": "잠실 마라공방",
        "region": "잠실", "region_aliases": ["잠실", "송파구", "서울"],
        ...
        "moods": ["캐주얼", "혼밥"],
        "features": ["웨이팅짧음", "단체가능"],
        "rating": 4.1, "review_count": 176,
        "hours": "매일 11:00 - 22:00",
        "address": "서울 송파구 잠실동 일대",
        "description": "매운맛 단계를 직접 고를 수 있는 마라탕 전문점.",
    },
    {
        "name": "잠실 스시오마카세 온",
        "region": "잠실", "region_aliases": ["잠실", "송파구", "서울"],
        "food_type": "일식", "cuisine": "오마카세",
        "signature_menu": "런치 오마카세 10피스",
        "price_tier": "5만원 이상", "avg_price_display": "1인 약 70,000원",
        "moods": ["데이트", "분위기 좋은", "조용한"],
        "features": ["예약가능", "룸있음"],
        "rating": 4.7, "review_count": 132,
        "hours": "화-일 12:00 - 21:00 (월요일 휴무)",
        "address": "서울 송파구 잠실동 일대",
        "description": "정갈한 제철 생선을 맛볼 수 있는 프리미엄 오마카세.",
    },
    {
        "name": "잠실 후라이드킹 3호점",
        "region": "잠실", "region_aliases": ["잠실", "송파구", "서울"],
        "food_type": "치킨", "cuisine": "치킨·맥주",
        "signature_menu": "마늘간장치킨",
        "price_tier": "1~2만원", "avg_price_display": "1인 약 19,000원",
        "moods": ["캐주얼", "가족", "회식"],
        "features": ["단체가능", "주차가능"],
        "rating": 4.3, "review_count": 214,
        "hours": "매일 15:00 - 24:00",
        "address": "서울 송파구 잠실동 일대",
        "description": "가족 단위 손님도 많이 찾는 동네 치킨집.",
    },
    {
        "name": "이태원 타코앤그릴",
        "region": "이태원", "region_aliases": ["이태원", "용산구", "서울"],
        "food_type": "양식", "cuisine": "멕시칸",
        "signature_menu": "스트릿 타코 플래터",
        "price_tier": "2~3만원", "avg_price_display": "1인 약 25,000원",
        "moods": ["캐주얼", "데이트", "분위기 좋은"],
        "features": ["웨이팅짧음", "예약가능"],
        "rating": 4.5, "review_count": 312,
        "hours": "매일 12:00 - 23:00",
        "address": "서울 용산구 이태원동 일대",
        "description": "이국적인 분위기에서 즐기는 정통 타코와 그릴 요리.",
    },
    {
        "name": "이태원 케밥하우스",
        "region": "이태원", "region_aliases": ["이태원", "용산구", "서울"],
        "food_type": "양식", "cuisine": "터키음식",
        "signature_menu": "도네르 케밥",
        "price_tier": "1~2만원", "avg_price_display": "1인 약 15,000원",
        "moods": ["캐주얼", "혼밥"],
        "features": ["웨이팅짧음"],
        ...
        "address": "서울 용산구 이태원동 일대",
        "description": "향신료 향이 매력적인 정통 케밥 전문점.",
    },
    {
        "name": "건대 곱창골목",
        "region": "건대", "region_aliases": ["건대", "건대입구", "광진구", "서울"],
        "food_type": "고기", "cuisine": "곱창",
        "signature_menu": "모듬 곱창구이",
        "price_tier": "2~3만원", "avg_price_display": "1인 약 26,000원",
        "moods": ["회식", "캐주얼"],
        "features": ["단체가능", "웨이팅짧음"],
        "rating": 4.4, "review_count": 356,
        "hours": "매일 16:00 - 02:00",
        "address": "서울 광진구 자양동 일대",
        "description": "쫄깃한 곱창과 함께 술 한 잔 하기 좋은 곳.",
    },
    {
        "name": "건대 감성라운지 카페",
        "region": "건대", "region_aliases": ["건대", "건대입구", "광진구", "서울"],
        "food_type": "카페", "cuisine": "디저트카페",
        "signature_menu": "인절미 라떼",
        "price_tier": "1만원 이하", "avg_price_display": "1인 약 8,500원",
        "moods": ["데이트", "조용한", "분위기 좋은"],
        "features": ["웨이팅짧음", "반려동물동반"],
        "rating": 4.5, "review_count": 298,
        "hours": "매일 11:00 - 23:00",
        "address": "서울 광진구 화양동 일대",
        "description": "조명이 예뻐서 사진 찍기 좋은 감성 카페.",
    },
    {
        "name": "신촌 대학로 국수",
        "region": "신촌", "region_aliases": ["신촌", "서대문구", "서울"],
        "food_type": "한식", "cuisine": "잔치국수",
        "signature_menu": "멸치육수 잔치국수",
        "price_tier": "1만원 이하", "avg_price_display": "1인 약 7,500원",
        "moods": ["혼밥", "캐주얼"],
        "features": ["웨이팅짧음"],
        "rating": 4.1, "review_count": 143,
        "hours": "매일 10:00 - 20:00",
        "address": "서울 서대문구 신촌동 일대",
        "description": "가볍고 든든하게 먹기 좋은 학생들의 단골 국수집.",
    },
]
